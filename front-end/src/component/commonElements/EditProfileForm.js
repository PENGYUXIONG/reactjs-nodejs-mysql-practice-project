...
class EditProfileForm extends Component{
  ...
  componentWillReceiveProps(nextProps){
    const isSuccess = nextProps.signedUpAvailable.userName && nextProps.signedUpAvailable.email;
    if (isSuccess === true){
  ...
  handleSubmit(event){
    ...
    if (this.state.userName.length < 4){
      ...
      this.props.updateuserinfo(credential);
    }
  };
...
export default connect(mapStateToProps, {updateuserinfo})(EditProfileForm);